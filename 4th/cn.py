...
def visualize_results(results, feature_types):
    ...
    plt.tight_layout()
    plt.savefig('feature_selection_comparison_synthetic.png'+a, 
                bbox_inches='tight', 
                dpi=300,
                pad_inches=0.2)
    plt.close()
...
def main():
    ...
    # Remove the scheduler initialization
    # dataset_size = batch_size * n_episodes
    # model.initialize_scheduler(dataset_size, batch_size, n_episodes)  # Remove this line
